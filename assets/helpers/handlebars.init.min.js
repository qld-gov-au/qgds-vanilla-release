...
// src/components/card_single_action/cardSingleAction.hbs?raw
var cardSingleAction_default;
var init_cardSingleAction = __esm({
  "src/components/card_single_action/cardSingleAction.hbs?raw"() {
    cardSingleAction_default = `<section class="qld__card--wrapper qld__body {{component.data.metadata.body_background.value}} {{component.data.metadata.body_background_type.value}}" id="{{#if component.data.metadata.id_field.value}}{{component.data.metadata.id_field.value}}{{else}}cards-single-{{component.data.assetid}}{{/if}}"
    {{#ifCond component.data.metadata.body_background_type.value '==' 'qld__card--wrapper-bg-image'}} style="background-image:url(./?a={{component.data.metadata.body_background_image.value}})"{{/ifCond}}
    {{#ifCond component.data.metadata.body_background_type.value '==' 'qld__card--wrapper-bg-pattern'}} style="background-image:url(./?a={{component.data.metadata.body_background_pattern.value}})"{{/ifCond}} >
...
function handlebarsPartials(handlebars) {
  ...
  handlebars.registerPartial("cardSingleAction", cardSingleAction_default);
