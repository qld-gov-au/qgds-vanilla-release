...
var init_component4 = __esm({
  "src/components/abstract/html/component.hbs?raw"() {
    component_default4 = '\n<section class="qld__abstract--wrapper" id="{{#if component.data.metadata.id_field.value}}{{{component.data.metadata.id_field.value}}}{{/if}}{{#if component.data.assetid}}abstract-{{{component.data.assetid}}}{{/if}}">\n    <div class="container-fluid">\n        <div class="qld__abstract{{#if component.data.display}} qld__display-{{component.data.display}}{{/if}}">\n            {{{component.data.content.value}}}\n        </div>\n    </div>\n</section>\n\n';
  }
});
