...
var inpage_navigation_default;
var init_inpage_navigation = __esm({
  "src/components/in_page_navigation/inpage-navigation.hbs?raw"() {
    inpage_navigation_default = `<nav class="qld__inpage-nav-links" aria-label="In page navigation" data-headingType="{{headingType}}" id="{{id}}"
...
function handlebarsPartials(handlebars) {
  ...
  handlebars.registerPartial("inpage-navigation", inpage_navigation_default);
