...
var init_layout_footer_scripts = __esm({
  "src/components/_global/hbs/layout_footer_scripts.hbs?raw"() {
    layout_footer_scripts_default = `<div class="footer-scripts" id="footer_js" style="display: none !important;">
    <script src="https://kit.fontawesome.com/fb2f2d4cd6.js" crossorigin="anonymous"></script>
    <script src="./assets/js/main.js"></script>
    <link rel="stylesheet" href="./assets/css/main-light.css" media="screen and (prefers-color-scheme: light)"/>
    <link rel="stylesheet" href="./assets/css/main-dark.css" media="screen and (prefers-color-scheme: dark)"/>
