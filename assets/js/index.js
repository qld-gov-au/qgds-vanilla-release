...
{{/ifCond}}`;
  ...
  // src/components/in_page_navigation/inpage-navigation.hbs?raw
  var inpage_navigation_default = `<nav class="qld__inpage-nav-links" aria-label="In page navigation" data-headingType="{{headingType}}" id="{{id}}"
  ...
  // src/components/in_page_navigation/inpage-navigation.js
  var inpage_navigation_default2 = {
    init() {
  ...
  // src/components/in_page_navigation/version.json
  ...
  // src/components/in_page_navigation/index.js
  function InpageNavigation({ data, template = inpage_navigation_default }) {
    document.addEventListener("DOMContentLoaded", () => {
      try {
    ...
    return new Component("InpageNavigation", props);
  }
