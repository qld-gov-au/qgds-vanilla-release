...
{{/ifCond}}`;
  ...
  function Accordion({ data, template = accordion_default }) {
    const props = {
      data,
      template,
      required: ["component", "theme"],
      meta: accordion_data_default || {}
    };
    return new Component("Accordion", props);
  }
