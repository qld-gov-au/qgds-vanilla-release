...
(() => {
  ...
  var Component = class {
     ...
     *
     */
    constructor(componentName2, template, data = {}) {
    ...
    makeHTML() {
      this.htmlstring = import_handlebars.default.compile(this.template)(this.data);
    }
    makeNode() {
      if (!this.htmlstring) {
        console.error(
  ...
  var example_default = '<div class="qld__page-alerts qld__page-alerts--info" data-component="qgds-example">\n\n  <div class="qld__page-alerts--heading qld__display-lg">\n    {{heading}}\n  </div>\n\n  {{{ description }}}\n\n</div>';
  ...
  // src/components/_example/example.data.json
  var example_data_default = {
    heading: "Example",
    description: 'This is a mockup component using example data. Visit the <a href="https://designsystem.qld.gov.au" target="_blank">Queensland Government Design System</a> for more information.'
  };

  // src/components/_example/index.js
  var Example = class {
    constructor(data = example_data_default) {
      example_default2.init();
      return new Component("Example", example_default, data);
    }
  };

  // src/js/myapp.js
  document.body.appendChild(new Example());
  console.log(new Example().html);
})();
